...
export const selectProductListByAdmin = createSelector(
  selectProductState,
  (state: ProductState) => {
    return {
...
export const selectProductDetail = createSelector(
  selectProductState,
  (state: ProductState) => state.itemDetail
);
export const selectProductById = createSelector(
  selectProductState,
  (state: ProductState) => state.itemById
);
export const selectProductListByBrand = createSelector(
  selectProductState,
  (state: ProductState) => {
    return {
...
export const selectProductListByCategory = createSelector(
  selectProductState,
  (state: ProductState) => {
    return {
